...
VALUES ('불금 볼링 점수 내기 하실 분~', 1, 1, DATEADD('DAY', 10, CURRENT_DATE()), DATEADD('DAY', 20, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 1, 659, DATEADD('DAY', -30, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 1, 2, DATEADD('DAY', -5, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 1, 1, DATEADD('DAY', -5, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 1, 2, DATEADD('DAY', -10, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 3, 1, DATEADD('DAY', -20, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 3, 1, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 3, 1, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 3, 1, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 3, 1, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 4, 2, DATEADD('DAY', -20, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 4, 2, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 4, 2, DATEADD('DAY', -20, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true),
       ('불금 볼링 점수 내기 하실 분~', 4, 2, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', false),
       ('불금 볼링 점수 내기 하실 분~', 4, 2, DATEADD('DAY', -60, CURRENT_DATE()), DATEADD('DAY', 30, CURRENT_DATE()), '볼링 점수 내기합시다.', true);
