...
public enum ErrorCode {
    ...
    FILE_UPLOAD_REQUEST_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "잘못된 파일 업로드 요청입니다."),
    INVALID_CONTENT_TYPE(HttpStatus.BAD_REQUEST, "허용되지 않는 파일 확장자입니다."),

    SCORE_UPLOAD_FAILED(HttpStatus.BAD_REQUEST, "점수 등록에 실패했습니다."),
    SCORE_UPDATE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "점수 정보에 대한 수정 권한이 없습니다."),
    SCORE_DELETE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "점수 정보에 대한 삭제 권한이 없습니다."),
    ...
    POST_UPDATE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "모집글에 대한 수정 권한이 없습니다."),
    POST_DELETE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "모집글에 대한 삭제 권한이 없습니다."),
    POST_CLOSE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "모집글에 대한 마감 권한이 없습니다."),

    COMMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 댓글입니다."),
    REPLY_TO_COMMENT_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "대댓글을 작성할 수 없는 댓글입니다."),
    COMMENT_UPDATE_FAILED(HttpStatus.FORBIDDEN, "본인의 댓글만 수정 가능합니다."),
    COMMENT_DELETE_FAILED(HttpStatus.FORBIDDEN, "본인의 댓글만 삭제 가능합니다."),

    MESSAGE_DELETE_FAILED(HttpStatus.FORBIDDEN, "본인의 쪽지만 삭제 가능합니다."),
    ...
    APPLICANT_NOT_ALLOWED(HttpStatus.FORBIDDEN, "신청에 대한 권한이 없습니다."),
    APPLICANT_REJECT_NOT_ALLOWED(HttpStatus.FORBIDDEN, "작성자만 거절 가능합니다."),
    APPLICANT_ACCEPT_NOT_ALLOWED(HttpStatus.FORBIDDEN, "작성자만 수락 가능합니다."),
    RATING_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "권한이 없습니다."),
    RATING_REQUEST_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "잘못된 평점 요청입니다."),
